...
public class Griffindor extends Hogwarts {
    ...
    public void printCompareFacult(Griffindor[] griffindors, String name1, String name2) {
        ...
        if (power1 > power2) {
            System.out.println(griffindors[k1].getName() + " лучший Гриффиндорец, чем " + griffindors[k2].getName());
        } else if (power2 > power1) {
            System.out.println(griffindors[k2].getName() + " лучший Гриффиндорец, чем " + griffindors[k1].getName());
        }
